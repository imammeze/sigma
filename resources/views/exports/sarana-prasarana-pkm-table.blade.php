...
<body>
    <div class="title">DAFTAR SARANA DAN PRASARANA PENGABDIAN KEPADA MASYARAKAT (PKM)</div>
    <table>
        <thead>
            <tr class="header">
                ...
                <th rowspan="2">Nama File Bukti</th>
            </tr>
            <tr class="header">
                <th>Daya</th>
                <th>Luas (m²)</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-left">
                    @if($row->bukti_files)
                        @php
                            $files = is_array($row->bukti_files) ? $row->bukti_files : [$row->bukti_files];
                        @endphp
